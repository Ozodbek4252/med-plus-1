                ...
                <form method="post" action="{{route('admin.addDoctor')}}" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10" style="display: flex;">
                      <input required value="{{$data->first_name}}" name="first_name" type="text" placeholder="Ism" class="form-control" style="margin-right: 10px;" />
                      <input required value="{{$data->last_name}}" name="last_name" type="text" placeholder="Familya" class="form-control" />
                    </div>
                  </div>
